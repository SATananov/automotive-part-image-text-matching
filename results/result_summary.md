...
|---|---:|---:|---:|
| Real-only multimodal CNN | 0.4583 | 0.4414 | 55/120 |
| Image + text Logistic Regression | 0.3333 | 0.1667 | 40/120 |
| Real + synthetic multimodal CNN | 0.4167 | 0.4121 | 50/120 |

The exact_image_group_sign_flip image-group paired comparison for the real-only neural model versus the non-neural multimodal baseline gives p = `0.178581` over 20 independent images.
The real-only model's grouped-bootstrap 95% accuracy interval is `[0.3000, 0.6167]`.
