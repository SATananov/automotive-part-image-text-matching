# FND-009 — Different preprocessing steps

This directory is the stable per-exercise evidence index reserved by the Step 011.0 course-coverage mapping.

- Execution status: **COMPLETED**
- Recorded training runs: **4**
- Configuration: `configs/course_coverage/experiments/FND-009.json`
...
- `reports/course_coverage/fundamentals/preprocessing_comparison.csv`
- `reports/course_coverage/fundamentals/figures/preprocessing_comparison.png`
