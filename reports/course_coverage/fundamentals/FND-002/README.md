# FND-002 — Data loaders and batch inspection
...
- Configuration: `configs/course_coverage/experiments/FND-002.json`
...
- `reports/course_coverage/fundamentals/batch_contract.json`
- `reports/course_coverage/fundamentals/sample_batch.csv`
