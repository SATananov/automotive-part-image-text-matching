# FND-005 — Training and validation loop
...
- Configuration: `configs/course_coverage/experiments/FND-005.json`
...
- `reports/course_coverage/fundamentals/training_loop_audit.json`
- `reports/course_coverage/fundamentals/training_histories.csv`
- `reports/course_coverage/fundamentals/validation_predictions.csv`
- `reports/course_coverage/fundamentals/confusion_matrices.json`
