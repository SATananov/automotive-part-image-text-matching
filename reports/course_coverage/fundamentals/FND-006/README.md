# FND-006 — Compare optimizers and learning rates

This directory is the stable per-exercise evidence index reserved by the Step 011.0 course-coverage mapping.

- Execution status: **COMPLETED**
- Recorded training runs: **11**
- Configuration: `configs/course_coverage/experiments/FND-006.json`
...
- `reports/course_coverage/fundamentals/optimizer_comparison.csv`
- `reports/course_coverage/fundamentals/optimizer_stability.json`
- `reports/course_coverage/fundamentals/figures/optimizer_macro_f1.png`
