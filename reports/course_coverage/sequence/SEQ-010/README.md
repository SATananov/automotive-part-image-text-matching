# SEQ-010 — Pretrained transformer

This directory is the stable per-exercise evidence index reserved by the Step 011.0 course-coverage mapping.

- Execution status: **DEFERRED_EXPLICIT_APPROVAL_REQUIRED**
- Recorded training runs: **0**
- Configuration: `configs/course_coverage/experiments/SEQ-010.json`
...
- `reports/course_coverage/sequence/pretrained_transformer_gate.json`
