# SEQ-008 — Evaluate and compare all sequence models
...
- Configuration: `configs/course_coverage/experiments/SEQ-008.json`
...
- `reports/course_coverage/sequence/confusion_matrices.json`
- `reports/course_coverage/sequence/roc_curves.json`
- `reports/course_coverage/sequence/validation_error_analysis.csv`
- `reports/course_coverage/sequence/figures/roc_curves.png`
