# SEQ-005 — Classical machine-learning baseline
...
- Configuration: `configs/course_coverage/experiments/SEQ-005.json`
...
- `reports/course_coverage/sequence/model_comparison.json`
- `reports/course_coverage/sequence/training_runs.csv`
