...
- Configuration: `configs/course_coverage/experiments/SEQ-003.json`
...
- `reports/course_coverage/sequence/tokenization_summary.json`
- `reports/course_coverage/sequence/tokenization_examples.csv`
- `reports/course_coverage/sequence/vocabulary.json`
