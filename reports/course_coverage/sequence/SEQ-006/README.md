# SEQ-006 — Text CNN and recurrent model

This directory is the stable per-exercise evidence index reserved by the Step 011.0 course-coverage mapping.

- Execution status: **COMPLETED**
- Recorded training runs: **9**
- Configuration: `configs/course_coverage/experiments/SEQ-006.json`
...
- `reports/course_coverage/sequence/model_comparison.csv`
- `reports/course_coverage/sequence/training_histories.csv`
- `reports/course_coverage/sequence/figures/model_macro_f1.png`
